...
- [Plausible data policy](https://plausible.io/data-policy):
  ...
  It cannot prove an active account for this site or access to its reports.
...
1. Confirm the production domain in the hosting dashboard, hosting/CDN providers,
   enabled logging, provider retention and any exported logs. Repository
...
3. Check Workspace administration, forwarding, connected tools, Vault licensing
   and holds, backup services and current deletion settings.
